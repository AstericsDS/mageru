<div class="relative container w-4xl mx-auto bg-white rounded-sm flex flex-col items-center pb-8 text-black">
    ...
    <div class="pt-20 pb-10 px-28 w-full">
        ...
        <form action="" class="flex flex-col mt-4 gap-4">
            ...
            <input type="password" placeholder="Password" class="bg-[#D9D9D9] rounded-sm py-2 px-3">
